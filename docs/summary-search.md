...
- Context safety: results are trimmed to `POWERSEARCH_FILTER_TOP_K` (default 10) and `POWERSEARCH_CONTENT_LIMIT` (if set) before sampling; chunking uses `POWERSEARCH_SUMMARY_CHUNK_SIZE` (default 4).
